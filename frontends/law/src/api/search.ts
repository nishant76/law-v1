...
// Open our self-hosted judgment PDF. The endpoint requires JWT, so we fetch
// the blob with the auth header and open it via an object URL — a plain anchor
// would 401. Returns false if the judgment could not be opened.
...
// Trigger a browser download of the judgment PDF.
